...
export const Hero = () => {
  return (
    <section className="min-h-[90vh] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-gray-900/80 to-purple-900/80"></div>
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button 
            size="lg" 
            className="cta-button bg-purple-500 hover:bg-purple-600 transform hover:scale-105 transition-all duration-300"
