...
import { ArrowUpRight, Users, Shield, Code, Clock, Activity, Lock } from "lucide-react";
...
export const Statistics = () => {
  const stats = [
    ...
    },
    {
      ...
      value: 50,
      icon: Clock,
      description: "Milliseconds average",
    },
    {
      title: "Daily Scans",
      value: 100000,
      icon: Activity,
      description: "Security checks per day",
    },
    {
      title: "Security Score",
      value: 99,
      icon: Lock,
      description: "Average protection rating",
    },
  ];
